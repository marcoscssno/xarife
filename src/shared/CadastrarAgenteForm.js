    ...
    return (
        <form onSubmit={handleSubmit} className={classes.form} autoComplete="off">
            <Grid container spacing={16}>
                <Grid item xs={12}>
                    <Typography variant="h6">Cadastrar Agente</Typography>
                </Grid>
                <Grid item xs={12}>
...
CadastrarAgenteForm = reduxForm({
    form: 'cadastrarAgente',
    validate,
    initialValues: {
        telefone: [{
            tipo: '',
...
})(withStyles(styles)(CadastrarAgenteForm))

CadastrarAgenteForm = connect(mapStateToProps)(CadastrarAgenteForm)

export default CadastrarAgenteForm